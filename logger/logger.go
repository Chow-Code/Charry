...
func Debugf(format string, args ...interface{}) {
	Logger.Desugar().WithOptions(zap.AddCallerSkip(1)).Sugar().Debugf(format, args...)
}

func Infof(format string, args ...interface{}) {
	Logger.Desugar().WithOptions(zap.AddCallerSkip(1)).Sugar().Infof(format, args...)
}

func Warnf(format string, args ...interface{}) {
	Logger.Desugar().WithOptions(zap.AddCallerSkip(1)).Sugar().Warnf(format, args...)
}

func Errorf(format string, args ...interface{}) {
	Logger.Desugar().WithOptions(zap.AddCallerSkip(1)).Sugar().Errorf(format, args...)
}

func Fatalf(format string, args ...interface{}) {
	Logger.Desugar().WithOptions(zap.AddCallerSkip(1)).Sugar().Fatalf(format, args...)
}
